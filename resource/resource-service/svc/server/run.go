...
import (
	...
	"github.com/sabnak227/jwt-demo/resource/resource-service/handlers"
...
func NewEndpoints() svc.Endpoints {
	...
	// Endpoint domain.
	var (
		getresourceEndpoint = svc.MakeGetResourceEndpoint(service)
	)
...
func Run(cfg Config) {
	...
	go func() {
		...
		s := grpc.NewServer()
		pb.RegisterResourceServer(s, srv)
