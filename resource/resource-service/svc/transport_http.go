...
func MakeHTTPHandler(endpoints Endpoints, options ...httptransport.ServerOption) http.Handler {
	...
	m.Methods("GET").Path("/resource").Handler(httptransport.NewServer(
		endpoints.GetResourceEndpoint,
		DecodeHTTPGetResourceZeroRequest,
...
// DecodeHTTPGetResourceZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded getresource request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPGetResourceZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	defer r.Body.Close()
	var req pb.ResourceRequest
