...
import (
	...
	"github.com/sabnak227/jwt-demo/scope/scope-service/handlers"
...
func NewEndpoints() svc.Endpoints {
	...
	// Endpoint domain.
	var (
		userscopeEndpoint = svc.MakeUserScopeEndpoint(service)
	)
