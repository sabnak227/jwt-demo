...
// DecodeHTTPUserScopeZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded userscope request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPUserScopeZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	defer r.Body.Close()
	var req pb.UserScopeRequest
